...
from clip_server.model.model import (_ntuple, LayerNorm,
                                    QuickGELU, CLIPTextCfg, CLIPVisionCfg,
                                    ModifiedResNet, TimmModel)
from modeling.module import ResidualAttentionBlock
...
class CLIP(nn.Module):
    ...
    def encode_text(self, text):
        ...
        x = x.permute(1, 0, 2)  # NLD -> LND
        x = self.transformer(x, attn_mask=self.attn_mask) # attn_mask
        x = x.permute(1, 0, 2)  # LND -> NLD
